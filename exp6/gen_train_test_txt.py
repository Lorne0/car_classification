...
with open("train.txt",'w+') as fp:
    ...
    for i in range(36456,67604):
        if dic[sv_train[i-36456]] in mc:
            ...
            errorcnt+=1
            if dic[sv_train[i-36456]] not in c531:
                c531[dic[sv_train[i-36456]]] = id531
                fp.write(str(i+1)+'.jpg '+str(id531)+'\n')
                id531 += 1
            else:
                fp.write(str(i+1)+'.jpg '+str(c531[dic[sv_train[i-36456]]])+'\n')
...
with open("test.txt",'w+') as fp:
    ...
    for i in range(15627,28960):
        if dic[sv_test[i-15627]] in mc:
            ...
            errorcnt+=1
            if dic[sv_test[i-15627]] not in c531:
                c531[dic[sv_test[i-15627]]] = id531
                fp.write(str(i+1)+'.jpg '+str(id531)+'\n')
                id531 += 1
                print "!!!!!!!!!!!!"
            else:
                c531list.append(i)
                fp.write(str(i+1)+'.jpg '+str(c531[dic[sv_test[i-15627]]])+'\n')
            #fp.write(str(i+1)+'.jpg '+str(10000)+'\n')
print errorcnt

np.save('c531map',c531)
c531list = np.array(c531list)
print len(c531list)
np.save('c531list',c531list)
c431list = np.array(c431list)
print len(c431list)
np.save('c431list',c431list)
